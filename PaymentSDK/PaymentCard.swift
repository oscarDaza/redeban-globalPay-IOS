...
@objcMembers open class PaymentCard:NSObject
{
    ...
    public static func createCard(cardHolder:String, cardNumber:String, expiryMonth:NSInteger, expiryYear:NSInteger, cvc:String) ->PaymentCard?
    {
        ...
        PaymentRCard.cardNumber = cardNumber
        PaymentRCard.cardHolder = cardHolder
        PaymentRCard.expiryMonth = "\(expiryMonth)"
        PaymentRCard.expiryYear = "\(expiryYear)"
        PaymentRCard.cvc = cvc
        return PaymentRCard
